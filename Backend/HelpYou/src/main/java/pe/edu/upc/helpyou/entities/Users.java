...
<<<<<<< HEAD:Backend/HelpYou/src/main/java/pe/edu/upc/helpyou/entities/Users.java
    ...
    public Users(Long id, String username, String password, Boolean enabled, String firstNameUser, String lastNameUser, String phoneNumberUser, String regionUser, String dniUser, String photoUser, String emailUser, List<Role> roles) {
        this.id = id;
